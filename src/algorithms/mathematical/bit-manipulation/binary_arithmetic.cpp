...
int main() {
    ...
    uint64_t mask_5 = ~((-1) << 32);
    uint64_t mask_4 = mask_5 ^ (mask_5 << 16);
    uint64_t mask_3 = mask_4 ^ (mask_4 << 8);
    uint64_t mask_2 = mask_3 ^ (mask_3 << 4);
    uint64_t mask_1 = mask_2 ^ (mask_2 << 2);
    uint64_t mask_0 = mask_1 ^ (mask_1 << 1);
