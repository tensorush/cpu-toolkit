...
int main() {
    ...
    const unsigned long PRIME_1 = 2747636419, PRIME_2 = 2654435769, TWO_TO_POWER_OF_THIRTY_TWO = 1 << 32;
    ...
    const long long PRIME_X = 73856093, PRIME_Y = 19349663, PRIME_Z = 83492791;
